...
\begin{titlepage}
	...
	%%%% AUTHOR(S)
	{\Large\itshape Ye Wenjie,\\ Ellen Ripley,\\ Victor Frankenstein\\}\par
	\vspace{1.5cm}

	\vfill
	supervised by\par
	%%%% SUPERVISOR(S)
	Liu Cixin, Ridley Scott, \& Mary Shelley
...
\begin{keywords}
\centering
        Here your keywords: eg. \textbf{Capstone; Computer science; NYU Shanghai}
\end{keywords}
